...
func InitializeApp() (*App, error) {
	...
	v := provideRouteRegistration(engine, userHandler, helloHandler, refreshTokenHandler, roleHandler, orgUnitHandler, auditLogHandler, userPermissionHandler, menuHandler)
	app := &App{
		DB: db,
		Redis: client,
		Logger: logger,
...
var providerSet = wire.NewSet(
	...
	provideTimeout, repository.NewUserRepo, repository.NewRoleRepository, repository.NewOrgUnitRepository, repository.NewAuditLogRepository, repository.NewMenuRepository, service.NewUserService, service.NewRefreshTokenService, service.NewPermissionService, service.NewRoleService, service.NewOrgUnitService, service.NewAuditLogService, service.NewMenuService, middleware.NewRBACMiddleware, handler.NewUserHandler, handler.NewHelloHandler, handler.NewRefreshTokenHandler, handler.NewRoleHandler, handler.NewOrgUnitHandler, handler.NewUserPermissionHandler, handler.NewAuditLogHandler, handler.NewMenuHandler,
)
