...
func (s *dictionaryService) ListDict(ctx context.Context, name, dictType string, status int, page, pageSize int) ([]entity.SysDictionary, int64, error) {
	return s.repo.ListDict(ctx, name, dictType, status, page, pageSize)
}
